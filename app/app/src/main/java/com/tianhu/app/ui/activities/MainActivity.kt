...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var batchRecognitionBtn: Button
    ...
    private fun initViews() {
        ...
        batchRecognitionBtn = findViewById(R.id.batchRecognitionBtn)
    ...
    private fun setupClickListeners() {
        ...
        batchRecognitionBtn.setOnClickListener {
            startActivity(Intent(this, BatchRecognitionActivity::class.java))
        }
